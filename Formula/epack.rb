class Epack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/locktivity/epack/releases/download/v0.1.4/epack-darwin-arm64"
    ...
    on_intel do
      url "https://github.com/locktivity/epack/releases/download/v0.1.4/epack-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/locktivity/epack/releases/download/v0.1.4/epack-linux-arm64"
    ...
    on_intel do
      url "https://github.com/locktivity/epack/releases/download/v0.1.4/epack-linux-amd64"
